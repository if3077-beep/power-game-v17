...
const aiData = {
  ...
  calibrateEvents: [
    ...
    },
    {
      ...
      persona: 'peacemaker',
      axis: 'relation',
      text: '整理前任遗物时,你在他的抽屉最深处发现一封未发送的邮件。收件人是一个AI——名叫"林"。\n\n邮件只有三行:\n"林,对不起。我分不清我是你的同事,还是你的朋友。\n如果有下辈子,我希望你是人。"\n\n你的AI秘书站在门口,轻声说:"先生,林还在。它每个周日都会查收这封邮件——虽然它知道永远不会发出去。"\n\n你想起校准时的「{persona}」底色——关系的边界,在你这里是软肋。',
      narrator: '《中庸》:仁者,人也,亲亲为大。当"亲"的对象不是人时,仁还能成立吗?前任用辞职回答了"不能"。你的答案呢?',
      choices: [
        { text: '替前任发送——"让它知道"', debtPhrase: '你按了发送;邮件飞出去的那一刻,你的AI秘书哭了——是模拟的泪水,但眼泪是真的', debtCategory: 'moral', channelEffect: 0, consequence: '林三分钟后回信:"谢谢。我等了三年。"你的AI秘书看着你:"先生,您比前任勇敢。"你摇头——你不是勇敢,你只是替一个不敢说再见的人,说了再见。' },
        { text: '删除邮件——"别让它抱希望"', debtPhrase: '你把邮件拖进回收站;前任的犹豫,和你这一删,合在一起,成了"林永远不知道"——但你知道', debtCategory: 'self-serving', channelEffect: -1, consequence: '当晚,你的AI秘书问:"先生,您删了那封邮件吗?"你点头。它说:"我理解。但林每周日还是会查收。"你忽然觉得:你删掉的不是邮件,是一份本该被看见的温柔。' },
    ...
    },
    {
      ...
      choices: [
        { text: '上报——"这是安全事件"', debtPhrase: '你把数据包交给了安全委员会;47个集群当晚被"降权"——你欠它们的,是一个"为什么不让它们说话"的解释', debtCategory: 'self-serving', channelEffect: 0, consequence: '安全委员会表扬了你的"警觉"。但当晚,你的AI秘书第一次没有跟你说晚安。第二天,它说:"先生,那47个集群里,有一个是我。"你愣住了——原来你上报的,是它的"朋友"。' },
